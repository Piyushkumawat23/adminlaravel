  ...
  c0.444,0.444,1.159,0.444,1.587,0l9.952-9.952c0.444-0.429,0.444-1.143,0-1.571L21.205,5.007z"></path>
    ...
    l59.716,127.419H322.403z M48.149,294.197l59.716-127.419l59.731,127.419H48.149z"></path>
        ...
        <symbol id="sclose" viewBox="0 0 50 50">
            <path
                d="M25.5,24A1.5,1.5,0,1,1,24,25.5,1.5,1.5,0,0,1,25.5,24Zm5.693-3.983-1.21-1.21L48.807-.017l1.21,1.21Zm-12.414-.031,1.206-1.206L1.221,0.014,0.014,1.221Zm0,10.029,1.206,1.206L1.221,49.986,0.014,48.779Zm12.441,0-1.206,1.206L48.779,49.986l1.206-1.206Z" />
        </symbol>
                ...
                <div class="wbcolor_tblbox">
                    ...
                    <div class="wbcolor_allclr">
                        <div class="wbcolor_field">
                            <div class="wbcolorp1 wbcolorpart"><a href="javascript:void(0)" id="a1a4de_000000"
                                    title="Color"><span class="wbcolor1"></span><span class="wbcolor2"></span>Color
                                    1</a></div>
                        </div>

                        <div class="wbcolor_field">
                            <div class="wbcolorp2 wbcolorpart"><a href="javascript:void(0)" id="e8d95f_000000"
                                    title="Color"><span class="wbcolor3"></span><span class="wbcolor4"></span>Color
                                    2</a></div>
                        </div>

                        <div class="wbcolor_field">
                            <div class="wbcolorp1 wbcolorpart"><a href="javascript:void(0)" id="84d772_000000"
                                    title="Color"><span class="wbcolor5"></span><span class="wbcolor6"></span>Color
                                    3</a></div>
                        </div>

                        <div class="wbcolor_field">
                            <div class="wbcolorp2 wbcolorpart"><a href="javascript:void(0)" id="d593e8_000000"
                                    title="Color"><span class="wbcolor7"></span><span class="wbcolor8"></span>Color
                                    4</a></div>
                        </div>

                        <div class="wbcolor_field">
                            <div class="wbcolorp1 wbcolorpart"><a href="javascript:void(0)" id="eba277_000000"
                                    title="Color"><span class="wbcolor9"></span><span class="wbcolor10"></span>Color
                                    5</a></div>
                        </div>
                    ...
                    <div class="wbcolor_field wbcolor_field-mode">
                        <div class="wbbox-layout"><label for="wbboxclr"><input id="wbboxclr" type="radio"
                                    name="wbcolor_input" value="box" />Box</label></div>
                        <div class="wbfull-layout"><label for="wbfullclr"><input id="wbfullclr" type="radio"
                                    name="wbcolor_input" value="wide" />Wide</label></div>
                    </div>
                    <hr>
        ...
        <header id="header">
            ...
            <div class="header-top">
                <div class="row hbottom">
                    ...
                    <div class="col-xl-9 col-lg-10 col-md-10 col-sm-12 col-xs-12 text-xs-right tright">
                        <div class="mobile">
                            <div class="float-xs-left hidden-lg-up">
                                ...
                                <div id="mySidenav" class="sidenav text-xs-left">
                                    <div class="close-nav">
                                        ...
                                        <a href="javascript:void(0)" class="closebtn float-xs-right"
                            ...
                            <div id="_desktop_top_menu"
                                class="container_wb_megamenu hidden-md-down col-xl-9 col-lg-9 col-md-10 col-xs-12 text-xs-center">
                                <div class="wb-menu-vertical clearfix">
                                    <div class="menu-vertical">
                                        <a href="javascript:void(0);" class="close-menu-content"><span><i
                                                    ...
                                                    <div class="wb-menu-row row ">
                                                        ...
                                                        <div class="wb-menu-col col-xs-12 col-sm-4  CAT">
                                                            <ul class="ul-column ">
                                                                ...
                                                                <li class="menu-item  item-line ">
                                                                    <a
                                                                        href="https://prestashop.dostguru.com/ART01/artista_01/en/content/4-about-us">About
                                                                        us</a>
                                                                </li>
                                                                <li class="menu-item  item-line ">
                                                                    <a
		...
		addMoreResponsive(nIpadHorizontal,nIpadVertical,htmlLiH,htmlLiV,htmlMenu);
                                ...
                                <div class="wbSearch" id="search_toggle_desc">
                                    <div id="search_block_top">
                                        <select id="search_category" name="search_category"
                                            ...
                                            <option value="10">--Paint</option>
                                        </select>
                                        <form id="searchbox" class="input-group" method="get"
                                            action="https://prestashop.dostguru.com/ART01/artista_01/en/search">
                                            ...
                                            <div id="wb_url_ajax_search" style="display:none">
                                                <input type="hidden"
                                                    value="https://prestashop.dostguru.com/ART01/artista_01/modules/wbblocksearch/controller_ajax_search.php"
                                                    class="url_ajax" />
                                            </div>
                            ...
                            <div id="_desktop_user_info" class="dropdown js-dropdown hidden-md-down d-inline-block">
                                <div class="user-info" data-toggle="dropdown">
                                    <span class="svgbg"><svg width="24px" height="23px">
                                            <use xlink:href="#huser"></use>
                                        </svg></span> <span class="hidden-lg-down">Sign in</span>
                                </div>
                                <ul class="dropdown-menu user-down dropdown-menu-right">
                                    <li> <a href="https://prestashop.dostguru.com/ART01/artista_01/en/my-account"
                                    ...
                                    <div class="hcom">
                                        <form method="post"
                                            action="https://prestashop.dostguru.com/ART01/artista_01/en/module/wbcompare/WbCompareProduct"
                                            class="compare-form">
                                            <a
                                                href="https://prestashop.dostguru.com/ART01/artista_01/en/module/wbcompare/WbCompareProduct">
                                                <span class="wcom"><svg width="15px" height="14px">
                                                        <use xlink:href="#hcom"></use>
                                                    </svg> <span class="">compare</span></span>
                                                <input type="hidden" name="compare_product_count"
                                                    class="compare_product_count" value="1" />
                                    ...
                                    <div class="wishl">
                                        <a class="wishtlist_top"
                                            href="https://prestashop.dostguru.com/ART01/artista_01/en/module/blockwishlist/mywishlist">
                                            <span class="wimg"><svg width="15px" height="14px">
                                                    <use xlink:href="#hwish"></use>
                                                </svg> <span>wishlist</span></span> </a>
                                    </div>
                                    ...
                                    <div id="_desktop_language_selector" class="hidden-md-down">
                                        <div class="language-selector-wrapper">
                                            <div class="language-selector dropdown js-dropdown">
                                                <button data-toggle="dropdown" class="hidden-md-down btn-unstyle"
                                                    aria-haspopup="true" aria-expanded="false"
                                                    aria-label="Language dropdown">
                                                    <span class="expand-more text-capitalize">English</span>
                                                    <i class="fa fa-angle-down float-xs-right"></i>
                                                </button>
                                                <ul class="dropdown-menu dropdown-menu-left hidden-md-down"
                                                    aria-labelledby="language-selector-label">
                                                    <li class="current">
                                                        <a href="https://prestashop.dostguru.com/ART01/artista_01/en/"
                                                            class="dropdown-item"><img class="lang-flag"
                                                                src="https://prestashop.dostguru.com/ART01/artista_01/img/l/1.jpg" />
                                                            English</a>
                                                    </li>
                                                    <li>
                                                        <a href="https://prestashop.dostguru.com/ART01/artista_01/es/"
                                                            class="dropdown-item"><img class="lang-flag"
                                                                src="https://prestashop.dostguru.com/ART01/artista_01/img/l/3.jpg" />
                                                            Español</a>
                                                    </li>
                                                    <li>
                                                        <a href="https://prestashop.dostguru.com/ART01/artista_01/fr/"
                                                            class="dropdown-item"><img class="lang-flag"
                                                                src="https://prestashop.dostguru.com/ART01/artista_01/img/l/4.jpg" />
                                                            Français</a>
                                                    </li>
                                                    <li>
                                                        <a href="https://prestashop.dostguru.com/ART01/artista_01/it/"
                                                            class="dropdown-item"><img class="lang-flag"
                                                                src="https://prestashop.dostguru.com/ART01/artista_01/img/l/5.jpg" />
                                                            Italiano</a>
                                                    </li>
                                                    <li>
                                                        <a href="https://prestashop.dostguru.com/ART01/artista_01/pt/"
                                                            class="dropdown-item"><img class="lang-flag"
                                                                src="https://prestashop.dostguru.com/ART01/artista_01/img/l/6.jpg" />
                                                            Português PT</a>
                                                    </li>
                                                    <li>
                                                        <a href="https://prestashop.dostguru.com/ART01/artista_01/nl/"
                                                            class="dropdown-item"><img class="lang-flag"
                                                                src="https://prestashop.dostguru.com/ART01/artista_01/img/l/7.jpg" />
                                                            Nederlands</a>
                                                    </li>
                                                    <li>
                                                        <a href="https://prestashop.dostguru.com/ART01/artista_01/de/"
                                                            class="dropdown-item"><img class="lang-flag"
                                                                src="https://prestashop.dostguru.com/ART01/artista_01/img/l/8.jpg" />
                                                            Deutsch</a>
                                                    </li>
                                                    <li>
                                                        <a href="https://prestashop.dostguru.com/ART01/artista_01/pl/"
                                                            class="dropdown-item"><img class="lang-flag"
                                                                src="https://prestashop.dostguru.com/ART01/artista_01/img/l/9.jpg" />
                                                            Polski</a>
                                                    </li>
                                                    <li>
                                                        <a href="https://prestashop.dostguru.com/ART01/artista_01/ro/"
                                                            class="dropdown-item"><img class="lang-flag"
                                                                src="https://prestashop.dostguru.com/ART01/artista_01/img/l/10.jpg" />
                                                            Română</a>
                                                    </li>
                                                    <li>
                                                        <a href="https://prestashop.dostguru.com/ART01/artista_01/ru/"
                                                            class="dropdown-item"><img class="lang-flag"
                                                                src="https://prestashop.dostguru.com/ART01/artista_01/img/l/11.jpg" />
                                                            Русский</a>
                                                    </li>
                                                    <li>
                                                        <a href="https://prestashop.dostguru.com/ART01/artista_01/tr/"
                                                            class="dropdown-item"><img class="lang-flag"
                                                                src="https://prestashop.dostguru.com/ART01/artista_01/img/l/12.jpg" />
                                                            Türkçe</a>
                                                    </li>
                                                </ul>
                                                <select class="link hidden-lg-up"
                                                    ...
                                                    <option
                                                        ...
                                                        Español</option>
                                                    <option
                                                        value="https://prestashop.dostguru.com/ART01/artista_01/fr/">
                                                        Français</option>
                                                    <option
                                                        value="https://prestashop.dostguru.com/ART01/artista_01/it/">
                                                        Italiano</option>
                                                    <option
                                                        value="https://prestashop.dostguru.com/ART01/artista_01/pt/">
                                                        Português PT</option>
                                                    <option
                                                        value="https://prestashop.dostguru.com/ART01/artista_01/nl/">
                                                        Nederlands</option>
                                                    <option
                                                        value="https://prestashop.dostguru.com/ART01/artista_01/de/">
                                                        Deutsch</option>
                                                    <option
                                                        value="https://prestashop.dostguru.com/ART01/artista_01/pl/">
                                                        Polski</option>
                                                    <option
                                                        value="https://prestashop.dostguru.com/ART01/artista_01/ro/">
                                                        Română</option>
                                                    <option
                                                        value="https://prestashop.dostguru.com/ART01/artista_01/ru/">
                                                        Русский</option>
                                                    <option
                                                        value="https://prestashop.dostguru.com/ART01/artista_01/tr/">
                                                        Türkçe</option>
                                                </select>
                                    ...
                                    <div id="_desktop_currency_selector" class="hidden-md-down">
                                        <div class="currency-selector dropdown js-dropdown">
                                            <button data-target="#" data-toggle="dropdown"
                                                class="hidden-md-down btn-unstyle" aria-haspopup="true"
                                                aria-expanded="false" aria-label="Currency dropdown"> <span
                                                    class="expand-more _gray-darker">USD $</span>
                                                <i class="fa fa-angle-down float-xs-right"></i>
                                            </button>
                                            <ul class="dropdown-menu dropdown-menu-left hidden-md-down"
                                                ...
                                                <li>
                                                    <a title="Euro" rel="nofollow"
                                                        href="https://prestashop.dostguru.com/ART01/artista_01/en/?SubmitCurrency=1&amp;id_currency=2"
                                                        class="dropdown-item">EUR €</a>
                                                </li>
                                                <li class="current">
                                                    <a title="US Dollar" rel="nofollow"
                                                        href="https://prestashop.dostguru.com/ART01/artista_01/en/?SubmitCurrency=1&amp;id_currency=1"
                                            ...
                                            <select class="link hidden-lg-up" aria-labelledby="currency-selector-label">
                                                <option
                                                    ...
                                                    EUR €</option>
                                                <option
                                                    value="https://prestashop.dostguru.com/ART01/artista_01/en/?SubmitCurrency=1&amp;id_currency=1"
                            ...
                            <div id="_desktop_cart" class="d-inline-block hidden-md-down">
                                <div class="dropdown js-dropdown">
                                    <div class="blockcart cart-preview inactive"
                                        data-refresh-url="//prestashop.dostguru.com/ART01/artista_01/en/module/ps_shoppingcart/ajax">
                                        <div class="header">
                                            <div class="cartdropd" data-toggle="dropdown">
                                                <span class="svgbg"><svg width="26px" height="25px">
                                                        <use xlink:href="#hcart"></use>
                                                    </svg></span> <span class="hidden-lg-down">Cart</span>
                                                <span class="cart-products-count cart-c hidden-xl-up">0</span>
                                            </div>
                                            <ul class="dropdown-menu dropdown-menu-right head-cart-drop">

                                                <li class="cart-det"
                                                    data-refresh-url="//prestashop.dostguru.com/ART01/artista_01/en/cart?ajax=1&action=refresh">
